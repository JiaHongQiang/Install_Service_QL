...
if [[ ${LocalIP} == '' ]] || [[ ${NatIP} == '' ]] || [[ ${NodeID} == '' ]] || [[ ${DomainCode} == '' ]] ; then
	echo "Parameters are LocalIP NatIP NodeID NatIP2 DomainCode, please input like this addnode.sh 192.168.1.66 192.168.1.66 3 192.168.16.143  a4bf014bb884"
	exit
fi
...
echo "add node local ip:${LocalIP}, nat ip:${NatIP}, node id:${NodeID},domain code:${DomainCode}"
...
safeExecsql $NodeID "delete from t_cmg_listen where NODE_ID ='1';"
...
safeExecsql $NodeID "insert into t_cmg_listen(NODE_ID, CONTAINER_ID, CMG_LISTEN_IPADDR, CMG_LISTEN_PORT, CMG_NAT_IPADDR, CMG_NAT_PORT) VALUES('${NodeID}',"1",'0.0.0.0',"5060",'${NatIP2}',"5060");"

if [[ ${NatIP2} != '' ]]; then
	safeExecsql $NodeID "insert into t_cmg_listen(NODE_ID, CONTAINER_ID, CMG_LISTEN_IPADDR, CMG_LISTEN_PORT, CMG_NAT_IPADDR, CMG_NAT_PORT) VALUES('${NodeID}',"1",'${NatIP2}',"1554",'${NatIP2}',"1554");"
fi
